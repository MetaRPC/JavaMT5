...
public final class AccountHelperGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest,
      mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply> getAllHistoryOrdersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AllHistoryOrders",
      requestType = mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest.class,
      responseType = mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest,
      mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply> getAllHistoryOrdersMethod() {
    io.grpc.MethodDescriptor<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest, mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply> getAllHistoryOrdersMethod;
    if ((getAllHistoryOrdersMethod = AccountHelperGrpc.getAllHistoryOrdersMethod) == null) {
      synchronized (AccountHelperGrpc.class) {
        if ((getAllHistoryOrdersMethod = AccountHelperGrpc.getAllHistoryOrdersMethod) == null) {
          AccountHelperGrpc.getAllHistoryOrdersMethod = getAllHistoryOrdersMethod =
              io.grpc.MethodDescriptor.<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest, mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AllHistoryOrders"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply.getDefaultInstance()))
              .setSchemaDescriptor(new AccountHelperMethodDescriptorSupplier("AllHistoryOrders"))
              .build();
        }
      }
    }
    return getAllHistoryOrdersMethod;
  }
  ...
  public static abstract class AccountHelperImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void allHistoryOrders(mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest request,
        io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAllHistoryOrdersMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getAllHistoryOrdersMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest,
                mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply>(
                  this, METHODID_ALL_HISTORY_ORDERS)))
          .build();
    }
  }
  ...
  public static final class AccountHelperStub extends io.grpc.stub.AbstractAsyncStub<AccountHelperStub> {
    ...
    public void allHistoryOrders(mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest request,
        io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getAllHistoryOrdersMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AccountHelperBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountHelperBlockingStub> {
    ...
    /**
     */
    public mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply allHistoryOrders(mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getAllHistoryOrdersMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class AccountHelperFutureStub extends io.grpc.stub.AbstractFutureStub<AccountHelperFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply> allHistoryOrders(
        mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getAllHistoryOrdersMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_ALL_HISTORY_ORDERS = 7;
      ...
      switch (methodId) {
        ...
        case METHODID_POSITIONS_HISTORY:
          serviceImpl.positionsHistory((mt5_term_api.Mt5TermApiAccountHelper.PositionsHistoryRequest) request,
              (io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiAccountHelper.PositionsHistoryReply>) responseObserver);
          break;
        case METHODID_ALL_HISTORY_ORDERS:
          serviceImpl.allHistoryOrders((mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersRequest) request,
              (io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiAccountHelper.AllHistoryOrdersReply>) responseObserver);
          break;
        default:
      ...
      synchronized (AccountHelperGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getAllHistoryOrdersMethod())
              .build();
        }
      }
    }
