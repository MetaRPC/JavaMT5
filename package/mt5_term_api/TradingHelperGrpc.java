...
public final class TradingHelperGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest,
      mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply> getOrderSendWithoutChecksMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OrderSendWithoutChecks",
      requestType = mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest.class,
      responseType = mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest,
      mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply> getOrderSendWithoutChecksMethod() {
    io.grpc.MethodDescriptor<mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest, mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply> getOrderSendWithoutChecksMethod;
    if ((getOrderSendWithoutChecksMethod = TradingHelperGrpc.getOrderSendWithoutChecksMethod) == null) {
      synchronized (TradingHelperGrpc.class) {
        if ((getOrderSendWithoutChecksMethod = TradingHelperGrpc.getOrderSendWithoutChecksMethod) == null) {
          TradingHelperGrpc.getOrderSendWithoutChecksMethod = getOrderSendWithoutChecksMethod =
              io.grpc.MethodDescriptor.<mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest, mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OrderSendWithoutChecks"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply.getDefaultInstance()))
              .setSchemaDescriptor(new TradingHelperMethodDescriptorSupplier("OrderSendWithoutChecks"))
              .build();
        }
      }
    }
    return getOrderSendWithoutChecksMethod;
  }
  ...
  public static abstract class TradingHelperImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void orderSendWithoutChecks(mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest request,
        io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getOrderSendWithoutChecksMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getOrderSendWithoutChecksMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest,
                mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply>(
                  this, METHODID_ORDER_SEND_WITHOUT_CHECKS)))
          .addMethod(
  ...
  public static final class TradingHelperStub extends io.grpc.stub.AbstractAsyncStub<TradingHelperStub> {
    ...
    public void orderSendWithoutChecks(mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest request,
        io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getOrderSendWithoutChecksMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class TradingHelperBlockingStub extends io.grpc.stub.AbstractBlockingStub<TradingHelperBlockingStub> {
     ...
     * </pre>
     */
    public mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply orderSendWithoutChecks(mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getOrderSendWithoutChecksMethod(), getCallOptions(), request);
    }
  ...
  public static final class TradingHelperFutureStub extends io.grpc.stub.AbstractFutureStub<TradingHelperFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply> orderSendWithoutChecks(
        mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getOrderSendWithoutChecksMethod(), getCallOptions()), request);
    }
  ...
  private static final int METHODID_ORDER_SEND_WITHOUT_CHECKS = 1;
  private static final int METHODID_ORDER_MODIFY = 2;
  private static final int METHODID_ORDER_CLOSE = 3;
      ...
      switch (methodId) {
        case METHODID_ORDER_SEND:
          serviceImpl.orderSend((mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest) request,
              (io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply>) responseObserver);
          break;
        case METHODID_ORDER_SEND_WITHOUT_CHECKS:
          serviceImpl.orderSendWithoutChecks((mt5_term_api.Mt5TermApiTradingHelper.OrderSendRequest) request,
              (io.grpc.stub.StreamObserver<mt5_term_api.Mt5TermApiTradingHelper.OrderSendReply>) responseObserver);
          break;
      ...
      synchronized (TradingHelperGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getOrderSendWithoutChecksMethod())
